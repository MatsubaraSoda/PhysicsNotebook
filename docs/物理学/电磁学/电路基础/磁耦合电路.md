...
1. 绕组电阻为零 (R<sub>1</sub> = 0 = R<sub>2</sub>)
    - 内容：无论是初级绕组（接电源一侧）还是次级绕组（接负载一侧），制造它们的导线（通常是铜线）完全没有电阻。
    - 这说明了：电流流过这些“完美”导线时，不会产生 I<sup>2</sup>R 的热量耗损（即焦耳热），也不会在绕组自身上产生任何电压降。能量在导线中没有损失。
2. 铁芯磁导率无限大 (&mu; -> &infin;)
...
4. 铁芯损耗为零 (Zero Core Losses)
    - 内容：在实际的交流磁场中，铁芯会因为磁场不断变化而发热。这种损耗主要分为两种：
        1. 磁滞损耗 (Hysteresis Loss)：磁性材料在磁化过程中，由于磁畴的旋转和摩擦，会产生能量损耗。
        2. 涡流损耗 (Eddy Current Loss)：在变化的磁场中，铁芯内部会产生感应电流，这些电流在铁芯内形成闭合回路，产生电阻损耗。
    - 这说明了：理想变压器假设这两种损耗完全不存在。铁芯在工作时是“冷静”的，不发热，不消耗能量。


### 教材推导

<Img src="/物理学/电磁学/电路基础/fig-13-21.png" alt="Determining the equivalent circuit of a linear transformer." maxHeight="180px" />
...
将 $\mathbf{I_1} = \displaystyle\frac{\mathbf{V}_1 - j \omega M \mathbf{I}_2}{j \omega L_1}$ 代入上式，得到：

$$
\mathbf{V}_2 = j \omega L_2 \mathbf{I}_2 + \frac{M \mathbf{V}_1}{L_1} - \frac{j \omega M^2 \mathbf{I}_2}{L_1}
$$

理想变压器满足 $M = 1 \cdot \sqrt{L_1 L_2}$，所以有：
...
<Img src="/物理学/电磁学/电路基础/fig-13-30.png" alt="(a) Ideal transformer, (b) circuit symbol for an ideal transformer." maxHeight="500px" />
...
$$
\boxed{
\frac{\mathbf{V}_2}{\mathbf{V}_1} = \frac{N_2}{N_1} = n
}
$$

<Img src="/物理学/电磁学/电路基础/fig-13-31.png" alt="Relating primary and secondary quantities in an ideal transformer." maxHeight="200px" />
...
$$
\frac{\mathbf{V}_2}{\mathbf{V}_1} = \frac{\mathbf{I}_1}{\mathbf{I}_2} = n
$$
...
$$
\mathbf{S}_1 = \mathbf{V}_1 \mathbf{I}_1^* = \mathbf{V}_2 \mathbf{I}_2^* = \mathbf{S}_2
$$

考虑阻抗：

$$
\mathbf{Z}_{\text{in}} = \frac{\mathbf{V}_1}{\mathbf{I}_1} = \frac{1}{n^2} \frac{\mathbf{V}_2}{\mathbf{I}_2} = \frac{\mathbf{Z}_L}{n^2} 
$$
...
<Img src="/物理学/电磁学/电路基础/fig-13-42-a.png" alt="Step-down autotransformer." maxHeight="250px" />

$$
\boxed{
\frac{\mathbf{V}_1}{\mathbf{V}_2} = \frac{N_1 + N_2}{N_2}
}
$$

Step-up autotransformer

<Img src="/物理学/电磁学/电路基础/fig-13-42-b.png" alt="Step-up autotransformer." maxHeight="250px" />

$$
\boxed{
\frac{\mathbf{V}_1}{\mathbf{V}_2} = \frac{N_1}{N_1 + N_2}
}
$$
...
<Img src="/物理学/电磁学/电路基础/fig-13-46.png" alt="Y-Y three-phase transformer connection." />

<Img src="/物理学/电磁学/电路基础/fig-13-47.png" alt="Δ-Δ three-phase transformer connection." />

<Img src="/物理学/电磁学/电路基础/fig-13-48.png" alt="Y-Δ three-phase transformer connection." />

<Img src="/物理学/电磁学/电路基础/fig-13-49.png" alt="Δ-Y three-phase transformer connection." />