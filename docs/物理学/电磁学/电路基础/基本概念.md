...
以 $\displaystyle\int x^2 e^{2x} \,\mathrm{d}x$ 为例：

$$
\begin{array}{c | c c c}
\text{Sign} & \mathrm{D} & & \mathrm{I} \\
\hline % 添加横线区分表头
+ & x^2 & \searrow & e^{2x} \\
- & 2x & \searrow & \displaystyle\frac{1}{2} e^{2x} \\
+ & 2 & \searrow & \displaystyle\frac{1}{4} e^{2x} \\
- & 0 & \searrow & \displaystyle\frac{1}{8} e^{2x} \\
\end{array}
$$

$$
\begin{aligned}
\text{Result} &= x^2 \cdot \displaystyle\frac{1}{2} e^{2x} - 2x \cdot \displaystyle\frac{1}{4} e^{2x} + 2 \cdot \displaystyle\frac{1}{8} e^{2x} + C \\

&= e^{2x} \left( \displaystyle\frac{1}{2} x^2 - \displaystyle\frac{1}{2} x + \displaystyle\frac{1}{4} \right) + C
\end{aligned}
$$
