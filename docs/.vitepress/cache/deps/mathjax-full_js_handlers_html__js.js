...
var require_LinkedList = __commonJS({
  "node_modules/mathjax-full/js/util/LinkedList.js"(exports) {
    "use strict";
    ...
    var LinkedList = function() {
      ...
      LinkedList2.prototype.isBefore = function(a, b) {
        return a < b;
      };
      LinkedList2.prototype.push = function() {
        var e_1, _a;
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
          args[_i] = arguments[_i];
      ...
      LinkedList2.prototype[Symbol.iterator] = function() {
        var current;
      ...
      LinkedList2.prototype.reversed = function() {
        var current;
        return __generator(this, function(_a) {
          switch (_a.label) {
            case 0:
      ...
      LinkedList2.prototype.insert = function(data, isBefore) {
        if (isBefore === void 0) {
          isBefore = null;
        }
        if (isBefore === null) {
      ...
      LinkedList2.prototype.sort = function(isBefore) {
        var e_4, _a;
        if (isBefore === void 0) {
          isBefore = null;
        }
        ...
        try {
          for (var _b = __values(this), _c = _b.next(); !_c.done; _c = _b.next()) {
            var item = _c.value;
            lists.push(new LinkedList2(item));
          }
        } catch (e_4_1) {
          e_4 = { error: e_4_1 };
        } finally {
      ...
      LinkedList2.prototype.merge = function(list, isBefore) {
        var _a, _b, _c, _d, _e;
        if (isBefore === void 0) {
          isBefore = null;
        }
...
var require_MathList = __commonJS({
  "node_modules/mathjax-full/js/core/MathList.js"(exports) {
    "use strict";
    ...
    var LinkedList_js_1 = require_LinkedList();
...
var require_BitField = __commonJS({
  "node_modules/mathjax-full/js/util/BitField.js"(exports) {
    "use strict";
    var __extends = exports && exports.__extends || /* @__PURE__ */ function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
    ...
    var BitField = function() {
      ...
      BitField2.has = function(name) {
        return this.names.has(name);
      };
      BitField2.prototype.set = function(name) {
        this.bits |= this.getBit(name);
      };
      BitField2.prototype.clear = function(name) {
        this.bits &= ~this.getBit(name);
      };
      BitField2.prototype.isSet = function(name) {
        return !!(this.bits & this.getBit(name));
      };
      BitField2.prototype.reset = function() {
        this.bits = 0;
      };
      BitField2.prototype.getBit = function(name) {
      ...
      BitField2.MAXBIT = 1 << 31;
      BitField2.next = 1;
      BitField2.names = /* @__PURE__ */ new Map();
      return BitField2;
    }();
...
var require_MathDocument = __commonJS({
  "node_modules/mathjax-full/js/core/MathDocument.js"(exports) {
    "use strict";
    var __extends = exports && exports.__extends || /* @__PURE__ */ function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
    ...
    var AbstractMathDocument = function() {
      function AbstractMathDocument2(document, adaptor, options) {
        var _this = this;
        ...
        this.processed = new AbstractMathDocument2.ProcessBits();
      ...
      Object.defineProperty(AbstractMathDocument2.prototype, "kind", {
        get: function() {
      ...
      AbstractMathDocument2.prototype.addRenderAction = function(id) {
        var action = [];
      ...
      AbstractMathDocument2.prototype.removeRenderAction = function(id) {
        var action = this.renderActions.findID(id);
        if (action) {
          this.renderActions.remove(action);
        }
      };
      AbstractMathDocument2.prototype.render = function() {
        this.renderActions.renderDoc(this);
        return this;
      };
      AbstractMathDocument2.prototype.rerender = function(start) {
        if (start === void 0) {
      ...
      AbstractMathDocument2.prototype.convert = function(math, options) {
        if (options === void 0) {
          options = {};
        }
        ...
        var jax = this.inputJax.reduce(function(jax2, ijax) {
          return ijax.name === format ? ijax : jax2;
        }, null);
      ...
      AbstractMathDocument2.prototype.findMath = function(_options) {
        if (_options === void 0) {
          _options = null;
        }
      ...
      AbstractMathDocument2.prototype.compile = function() {
        var e_6, _a, e_7, _b;
      ...
      AbstractMathDocument2.prototype.compileMath = function(math) {
        try {
          math.compile(this);
        } catch (err) {
      ...
      AbstractMathDocument2.prototype.compileError = function(math, err) {
      ...
      AbstractMathDocument2.prototype.typeset = function() {
        var e_8, _a;
      ...
      AbstractMathDocument2.prototype.typesetError = function(math, err) {
      ...
      AbstractMathDocument2.prototype.getMetrics = function() {
      ...
      AbstractMathDocument2.prototype.updateDocument = function() {
        var e_9, _a;
      ...
      AbstractMathDocument2.prototype.removeFromDocument = function(_restore) {
        if (_restore === void 0) {
          _restore = false;
        }
        return this;
      ...
      AbstractMathDocument2.prototype.reset = function(options) {
        var _a;
        if (options === void 0) {
      ...
      AbstractMathDocument2.prototype.clear = function() {
        this.reset();
        this.math.clear();
        return this;
      };
      AbstractMathDocument2.prototype.concat = function(list) {
        this.math.merge(list);
        return this;
      };
      AbstractMathDocument2.prototype.clearMathItemsWithin = function(containers) {
        var _a;
        var items = this.getMathItemsWithin(containers);
        (_a = this.math).remove.apply(_a, __spreadArray([], __read(items), false));
        return items;
      };
      AbstractMathDocument2.prototype.getMathItemsWithin = function(elements) {
        var e_11, _a, e_12, _b;
      ...
      AbstractMathDocument2.KIND = "MathDocument";
      AbstractMathDocument2.OPTIONS = {
        OutputJax: null,
        InputJax: null,
        MmlFactory: null,
      ...
      AbstractMathDocument2.ProcessBits = (0, BitField_js_1.BitFieldClass)("findMath", "compile", "getMetrics", "typeset", "updateDocument");
      return AbstractMathDocument2;
    }();
...
var require_Handler = __commonJS({
  "node_modules/mathjax-full/js/core/Handler.js"(exports) {
    "use strict";
    var __extends = exports && exports.__extends || /* @__PURE__ */ function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
    ...
    var MathDocument_js_1 = require_MathDocument();
    ...
    var AbstractHandler = function() {
      ...
      AbstractHandler2.prototype.handlesDocument = function(_document) {
        return false;
      };
      AbstractHandler2.prototype.create = function(document, options) {
        return new this.documentClass(document, this.adaptor, options);
      };
      AbstractHandler2.NAME = "generic";
...
var require_HTMLMathItem = __commonJS({
  "node_modules/mathjax-full/js/handlers/html/HTMLMathItem.js"(exports) {
    "use strict";
    var __extends = exports && exports.__extends || /* @__PURE__ */ function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
...
var require_HTMLMathList = __commonJS({
  "node_modules/mathjax-full/js/handlers/html/HTMLMathList.js"(exports) {
    "use strict";
    var __extends = exports && exports.__extends || /* @__PURE__ */ function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
...
var require_HTMLDomStrings = __commonJS({
  "node_modules/mathjax-full/js/handlers/html/HTMLDomStrings.js"(exports) {
    "use strict";
    var __read = exports && exports.__read || function(o, n) {
      var m = typeof Symbol === "function" && o[Symbol.iterator];
      if (!m) return o;
    ...
    var HTMLDomStrings = function() {
      function HTMLDomStrings2(options) {
        if (options === void 0) {
          options = null;
        }
        var CLASS = this.constructor;
      ...
      HTMLDomStrings2.prototype.init = function() {
        this.strings = [];
        this.string = "";
        this.snodes = [];
        this.nodes = [];
      ...
      HTMLDomStrings2.prototype.getPatterns = function() {
      ...
      HTMLDomStrings2.prototype.pushString = function() {
      ...
      HTMLDomStrings2.prototype.extendString = function(node, text) {
        this.snodes.push([node, text.length]);
        this.string += text;
      };
      HTMLDomStrings2.prototype.handleText = function(node, ignore) {
        if (!ignore) {
          this.extendString(node, this.adaptor.value(node));
        }
        return this.adaptor.next(node);
      };
      HTMLDomStrings2.prototype.handleTag = function(node, ignore) {
        if (!ignore) {
      ...
      HTMLDomStrings2.prototype.handleContainer = function(node, ignore) {
        this.pushString();
      ...
      HTMLDomStrings2.prototype.handleOther = function(node, _ignore) {
        this.pushString();
        return this.adaptor.next(node);
      };
      HTMLDomStrings2.prototype.find = function(node) {
        var _a, _b;
        this.init();
      ...
      HTMLDomStrings2.OPTIONS = {
        skipHtmlTags: ["script", "noscript", "style", "textarea", "pre", "code", "annotation", "annotation-xml"],
        includeHtmlTags: { br: "\n", wbr: "", "#comment": "" },
        ignoreHtmlClass: "mathjax_ignore",
        processHtmlClass: "mathjax_process"
      };
      return HTMLDomStrings2;
    }();
...
var require_HTMLDocument = __commonJS({
  "node_modules/mathjax-full/js/handlers/html/HTMLDocument.js"(exports) {
    "use strict";
    var __extends = exports && exports.__extends || /* @__PURE__ */ function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
    ...
    var MathDocument_js_1 = require_MathDocument();
    var Options_js_1 = require_Options();
    var HTMLMathItem_js_1 = require_HTMLMathItem();
    var HTMLMathList_js_1 = require_HTMLMathList();
    var HTMLDomStrings_js_1 = require_HTMLDomStrings();
    var MathItem_js_1 = require_MathItem();
...
var require_HTMLHandler = __commonJS({
  "node_modules/mathjax-full/js/handlers/html/HTMLHandler.js"(exports) {
    "use strict";
    var __extends = exports && exports.__extends || /* @__PURE__ */ function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
    ...
    var HTMLDocument_js_1 = require_HTMLDocument();
...
var require_html = __commonJS({
  "node_modules/mathjax-full/js/handlers/html.js"(exports) {
    Object.defineProperty(exports, "__esModule", { value: true });
...
//# sourceMappingURL=mathjax-full_js_handlers_html__js.js.map
