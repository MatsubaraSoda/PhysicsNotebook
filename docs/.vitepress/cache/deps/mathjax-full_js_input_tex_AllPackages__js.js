...
var require_ActionConfiguration = __commonJS({
  "node_modules/mathjax-full/js/input/tex/action/ActionConfiguration.js"(exports) {
    "use strict";
...
var require_AmsItems = __commonJS({
  "node_modules/mathjax-full/js/input/tex/ams/AmsItems.js"(exports) {
    "use strict";
    ...
    var BaseItems_js_1 = require_BaseItems();
    ...
    var FlalignItem = function(_super) {
      __extends(FlalignItem2, _super);
      function FlalignItem2(factory, name, numbered, padded, center) {
        var _this = _super.call(this, factory) || this;
        _this.name = name;
      ...
      Object.defineProperty(FlalignItem2.prototype, "kind", {
        get: function() {
          return "flalign";
        },
        enumerable: false,
      ...
      FlalignItem2.prototype.EndEntry = function() {
      ...
      FlalignItem2.prototype.EndRow = function() {
        var cell;
        var row = this.row;
        var n = this.getProperty("xalignat");
        while (row.length < n) {
      ...
      FlalignItem2.prototype.EndTable = function() {
        _super.prototype.EndTable.call(this);
        if (this.center) {
          if (this.maxrow <= 2) {
...
var require_AmsMethods = __commonJS({
  "node_modules/mathjax-full/js/input/tex/ams/AmsMethods.js"(exports) {
    "use strict";
    var __assign = exports && exports.__assign || function() {
      __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
...
var require_AmsMappings = __commonJS({
  "node_modules/mathjax-full/js/input/tex/ams/AmsMappings.js"(exports) {
    "use strict";
    ...
    Object.defineProperty(exports, "__esModule", { value: true });
    var AmsMethods_js_1 = require_AmsMethods();
...
var require_AmsConfiguration = __commonJS({
  "node_modules/mathjax-full/js/input/tex/ams/AmsConfiguration.js"(exports) {
    "use strict";
    var __extends = exports && exports.__extends || /* @__PURE__ */ function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
    ...
    var Configuration_js_1 = require_Configuration();
    var AmsItems_js_1 = require_AmsItems();
...
var require_AmsCdMethods = __commonJS({
  "node_modules/mathjax-full/js/input/tex/amscd/AmsCdMethods.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    Object.defineProperty(exports, "__esModule", { value: true });
    var TexParser_js_1 = __importDefault(require_TexParser());
    var BaseConfiguration_js_1 = require_BaseConfiguration();
    var MmlNode_js_1 = require_MmlNode();
    var NodeUtil_js_1 = __importDefault(require_NodeUtil());
    var AmsCdMethods = {};
    ...
    AmsCdMethods.arrow = function(parser, name) {
      ...
      var mml;
      var hdef = { minsize: top.getProperty("minw"), stretchy: true }, vdef = {
...
var require_AmsCdMappings = __commonJS({
  "node_modules/mathjax-full/js/input/tex/amscd/AmsCdMappings.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0) k2 = k;
      var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    var sm = __importStar(require_SymbolMap());
    var ParseMethods_js_1 = __importDefault(require_ParseMethods());
    var AmsCdMethods_js_1 = __importDefault(require_AmsCdMethods());
...
var require_AmsCdConfiguration = __commonJS({
  "node_modules/mathjax-full/js/input/tex/amscd/AmsCdConfiguration.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.AmsCdConfiguration = void 0;
    var Configuration_js_1 = require_Configuration();
    require_AmsCdMappings();
...
var require_BboxConfiguration = __commonJS({
  "node_modules/mathjax-full/js/input/tex/bbox/BboxConfiguration.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
...
var require_BoldsymbolConfiguration = __commonJS({
  "node_modules/mathjax-full/js/input/tex/boldsymbol/BoldsymbolConfiguration.js"(exports) {
    "use strict";
...
var require_BraketItems = __commonJS({
  "node_modules/mathjax-full/js/input/tex/braket/BraketItems.js"(exports) {
    "use strict";
    var __extends = exports && exports.__extends || /* @__PURE__ */ function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
    ...
    var BraketItem = function(_super) {
      ...
      BraketItem2.prototype.toMml = function() {
        ...
        var mrow = this.create("node", "mrow", [openNode, inner, closeNode], { open, close, texClass: MmlNode_js_1.TEXCLASS.INNER });
        return mrow;
      };
      return BraketItem2;
...
var require_BraketMethods = __commonJS({
  "node_modules/mathjax-full/js/input/tex/braket/BraketMethods.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
...
var require_BraketMappings = __commonJS({
  "node_modules/mathjax-full/js/input/tex/braket/BraketMappings.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    Object.defineProperty(exports, "__esModule", { value: true });
    var SymbolMap_js_1 = require_SymbolMap();
    var BraketMethods_js_1 = __importDefault(require_BraketMethods());
...
var require_BraketConfiguration = __commonJS({
  "node_modules/mathjax-full/js/input/tex/braket/BraketConfiguration.js"(exports) {
    "use strict";
    var _a;
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.BraketConfiguration = void 0;
    var Configuration_js_1 = require_Configuration();
    var BraketItems_js_1 = require_BraketItems();
    require_BraketMappings();
...
var require_BussproofsUtil = __commonJS({
  "node_modules/mathjax-full/js/input/tex/bussproofs/BussproofsUtil.js"(exports) {
    "use strict";
    var __read = exports && exports.__read || function(o, n) {
      var m = typeof Symbol === "function" && o[Symbol.iterator];
      if (!m) return o;
    ...
    var adjustSequentPairwise = function(config, sequents) {
      ...
      while (sequents.length) {
        ...
        var _a2 = __read(compareSequents(top, bottom), 2), left = _a2[0], right = _a2[1];
...
var require_BussproofsItems = __commonJS({
  "node_modules/mathjax-full/js/input/tex/bussproofs/BussproofsItems.js"(exports) {
    "use strict";
    var __extends = exports && exports.__extends || /* @__PURE__ */ function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
    ...
    var BussproofsUtil = __importStar(require_BussproofsUtil());
...
var require_BussproofsMethods = __commonJS({
  "node_modules/mathjax-full/js/input/tex/bussproofs/BussproofsMethods.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0) k2 = k;
      var desc = Object.getOwnPropertyDescriptor(m, k);
...
var require_BussproofsMappings = __commonJS({
  "node_modules/mathjax-full/js/input/tex/bussproofs/BussproofsMappings.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    Object.defineProperty(exports, "__esModule", { value: true });
    var BussproofsMethods_js_1 = __importDefault(require_BussproofsMethods());
    var ParseMethods_js_1 = __importDefault(require_ParseMethods());
    var SymbolMap_js_1 = require_SymbolMap();
...
var require_BussproofsConfiguration = __commonJS({
  "node_modules/mathjax-full/js/input/tex/bussproofs/BussproofsConfiguration.js"(exports) {
    "use strict";
    var _a;
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.BussproofsConfiguration = void 0;
    var Configuration_js_1 = require_Configuration();
    var BussproofsItems_js_1 = require_BussproofsItems();
    var BussproofsUtil_js_1 = require_BussproofsUtil();
    require_BussproofsMappings();
...
var require_EncloseConfiguration = __commonJS({
  "node_modules/mathjax-full/js/input/tex/enclose/EncloseConfiguration.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
...
var require_CancelConfiguration = __commonJS({
  "node_modules/mathjax-full/js/input/tex/cancel/CancelConfiguration.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    ...
    var SymbolMap_js_1 = require_SymbolMap();
    var ParseUtil_js_1 = __importDefault(require_ParseUtil());
    var EncloseConfiguration_js_1 = require_EncloseConfiguration();
...
var require_EmpheqUtil = __commonJS({
  "node_modules/mathjax-full/js/input/tex/empheq/EmpheqUtil.js"(exports) {
    "use strict";
    var __read = exports && exports.__read || function(o, n) {
      var m = typeof Symbol === "function" && o[Symbol.iterator];
      if (!m) return o;
...
var require_CasesConfiguration = __commonJS({
  "node_modules/mathjax-full/js/input/tex/cases/CasesConfiguration.js"(exports) {
    "use strict";
    var __extends = exports && exports.__extends || /* @__PURE__ */ function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
    ...
    var TexError_js_1 = __importDefault(require_TexError());
    var BaseItems_js_1 = require_BaseItems();
    var AmsConfiguration_js_1 = require_AmsConfiguration();
    var EmpheqUtil_js_1 = require_EmpheqUtil();
    var CasesBeginItem = function(_super) {
      __extends(CasesBeginItem2, _super);
      function CasesBeginItem2() {
        return _super !== null && _super.apply(this, arguments) || this;
      }
      Object.defineProperty(CasesBeginItem2.prototype, "kind", {
        get: function() {
          return "cases-begin";
        },
        enumerable: false,
      ...
      CasesBeginItem2.prototype.checkItem = function(item) {
    ...
    var CasesTags = function(_super) {
      ...
      CasesTags2.prototype.formatNumber = function(n, m) {
        if (m === void 0) {
          m = null;
        }
        return n.toString() + (m === null ? "" : String.fromCharCode(96 + m));
      };
      return CasesTags2;
...
var require_CenternotConfiguration = __commonJS({
  "node_modules/mathjax-full/js/input/tex/centernot/CenternotConfiguration.js"(exports) {
    "use strict";
    var __values = exports && exports.__values || function(o) {
      var s = typeof Symbol === "function" && Symbol.iterator, m = s && o[s], i = 0;
      if (m) return m.call(o);
    ...
    function filterCenterOver(_a) {
      ...
      try {
        for (var _c = __values(data.getList("centerOver")), _d = _c.next(); !_d.done; _d = _c.next()) {
          ...
          if (texClass !== null) {
            NodeUtil_js_1.default.setProperties(base.parent.parent.parent.parent.parent.parent, { texClass });
          }
        }
      } catch (e_1_1) {
        e_1 = { error: e_1_1 };
...
var require_ColorMethods = __commonJS({
  "node_modules/mathjax-full/js/input/tex/color/ColorMethods.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
...
var require_ColorConstants = __commonJS({
  "node_modules/mathjax-full/js/input/tex/color/ColorConstants.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.COLORS = void 0;
    exports.COLORS = /* @__PURE__ */ new Map([
      ["Apricot", "#FBB982"],
      ["Aquamarine", "#00B5BE"],
      ["Bittersweet", "#C04F17"],
      ["Black", "#221E1F"],
...
var require_ColorUtil = __commonJS({
  "node_modules/mathjax-full/js/input/tex/color/ColorUtil.js"(exports) {
    "use strict";
    var __values = exports && exports.__values || function(o) {
      var s = typeof Symbol === "function" && Symbol.iterator, m = s && o[s], i = 0;
      if (m) return m.call(o);
    ...
    var TexError_js_1 = __importDefault(require_TexError());
    var ColorConstants_js_1 = require_ColorConstants();
    var ColorModelProcessors = /* @__PURE__ */ new Map();
    var ColorModel = function() {
      function ColorModel2() {
        this.userColors = /* @__PURE__ */ new Map();
      }
      ColorModel2.prototype.normalizeColor = function(model, def) {
      ...
      ColorModel2.prototype.getColor = function(model, def) {
        if (!model || model === "named") {
          return this.getColorByName(def);
        }
        return this.normalizeColor(model, def);
      };
      ColorModel2.prototype.getColorByName = function(name) {
      ...
      ColorModel2.prototype.defineColor = function(model, name, def) {
...
var require_ColorConfiguration = __commonJS({
  "node_modules/mathjax-full/js/input/tex/color/ColorConfiguration.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.ColorConfiguration = void 0;
    var SymbolMap_js_1 = require_SymbolMap();
    var Configuration_js_1 = require_Configuration();
    var ColorMethods_js_1 = require_ColorMethods();
    var ColorUtil_js_1 = require_ColorUtil();
...
var require_ColorV2Configuration = __commonJS({
  "node_modules/mathjax-full/js/input/tex/colorv2/ColorV2Configuration.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_ColortblConfiguration = __commonJS({
  "node_modules/mathjax-full/js/input/tex/colortbl/ColortblConfiguration.js"(exports) {
    "use strict";
    var __extends = exports && exports.__extends || /* @__PURE__ */ function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
    ...
    var ColorArrayItem = function(_super) {
      __extends(ColorArrayItem2, _super);
      function ColorArrayItem2() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.color = {
          cell: "",
          row: "",
      ...
      ColorArrayItem2.prototype.EndEntry = function() {
        _super.prototype.EndEntry.call(this);
      ...
      ColorArrayItem2.prototype.EndRow = function() {
        _super.prototype.EndRow.call(this);
        this.color.row = "";
      };
      ColorArrayItem2.prototype.createMml = function() {
    ...
    var config = function(config2, jax) {
      if (!jax.parseOptions.packageData.has("color")) {
        Configuration_js_1.ConfigurationHandler.get("color").config(config2, jax);
      }
    };
...
var require_NewcommandUtil = __commonJS({
  "node_modules/mathjax-full/js/input/tex/newcommand/NewcommandUtil.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    ...
    (function(NewcommandUtil2) {
      ...
      NewcommandUtil2.disassembleSymbol = disassembleSymbol;
      ...
      NewcommandUtil2.assembleSymbol = assembleSymbol;
      ...
      NewcommandUtil2.GetCSname = GetCSname;
      ...
      NewcommandUtil2.GetCsNameArgument = GetCsNameArgument;
      ...
      NewcommandUtil2.GetArgCount = GetArgCount;
      ...
      NewcommandUtil2.GetTemplate = GetTemplate;
      ...
      NewcommandUtil2.GetParameter = GetParameter;
      ...
      NewcommandUtil2.MatchParam = MatchParam;
      function addDelimiter(parser, cs, char, attr) {
        var handlers = parser.configuration.handlers;
        var handler = handlers.retrieve(NewcommandUtil2.NEW_DELIMITER);
        handler.add(cs, new Symbol_js_1.Symbol(cs, char, attr));
      }
      NewcommandUtil2.addDelimiter = addDelimiter;
      function addMacro(parser, cs, func, attr, symbol) {
        if (symbol === void 0) {
          symbol = "";
        }
        var handlers = parser.configuration.handlers;
        var handler = handlers.retrieve(NewcommandUtil2.NEW_COMMAND);
        handler.add(cs, new Symbol_js_1.Macro(symbol ? symbol : cs, func, attr));
      }
      NewcommandUtil2.addMacro = addMacro;
      function addEnvironment(parser, env, func, attr) {
        var handlers = parser.configuration.handlers;
        var handler = handlers.retrieve(NewcommandUtil2.NEW_ENVIRONMENT);
        handler.add(env, new Symbol_js_1.Macro(env, func, attr));
      }
      NewcommandUtil2.addEnvironment = addEnvironment;
      NewcommandUtil2.NEW_DELIMITER = "new-Delimiter";
      NewcommandUtil2.NEW_COMMAND = "new-Command";
      NewcommandUtil2.NEW_ENVIRONMENT = "new-Environment";
...
var require_NewcommandMethods = __commonJS({
  "node_modules/mathjax-full/js/input/tex/newcommand/NewcommandMethods.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0) k2 = k;
      var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    var BaseMethods_js_1 = __importDefault(require_BaseMethods());
    var ParseUtil_js_1 = __importDefault(require_ParseUtil());
    var NewcommandUtil_js_1 = __importDefault(require_NewcommandUtil());
...
var require_NewcommandItems = __commonJS({
  "node_modules/mathjax-full/js/input/tex/newcommand/NewcommandItems.js"(exports) {
    "use strict";
    var __extends = exports && exports.__extends || /* @__PURE__ */ function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
...
var require_ConfigMacrosConfiguration = __commonJS({
  "node_modules/mathjax-full/js/input/tex/configmacros/ConfigMacrosConfiguration.js"(exports) {
    "use strict";
    var __values = exports && exports.__values || function(o) {
      var s = typeof Symbol === "function" && Symbol.iterator, m = s && o[s], i = 0;
      if (m) return m.call(o);
    ...
    var ParseMethods_js_1 = __importDefault(require_ParseMethods());
    var Symbol_js_1 = require_Symbol();
    var NewcommandMethods_js_1 = __importDefault(require_NewcommandMethods());
    var NewcommandItems_js_1 = require_NewcommandItems();
...
var require_EmpheqConfiguration = __commonJS({
  "node_modules/mathjax-full/js/input/tex/empheq/EmpheqConfiguration.js"(exports) {
    "use strict";
    var __extends = exports && exports.__extends || /* @__PURE__ */ function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
    ...
    var EmpheqBeginItem = function(_super) {
      __extends(EmpheqBeginItem2, _super);
      function EmpheqBeginItem2() {
        return _super !== null && _super.apply(this, arguments) || this;
      }
      Object.defineProperty(EmpheqBeginItem2.prototype, "kind", {
        get: function() {
          return "empheq-begin";
        },
        enumerable: false,
      ...
      EmpheqBeginItem2.prototype.checkItem = function(item) {
        if (item.isKind("end") && item.getName() === this.getName()) {
          this.setProperty("end", false);
        }
        return _super.prototype.checkItem.call(this, item);
      };
      return EmpheqBeginItem2;
    }(BaseItems_js_1.BeginItem);
    ...
    exports.EmpheqMethods = {
      Empheq: function(parser, begin) {
        if (parser.stack.env.closing === begin.getName()) {
          ...
          var _a2 = __read((parser.GetArgument("\\begin{" + begin.getName() + "}") || "").split(/=/), 2), env = _a2[0], n = _a2[1];
...
var require_NewcommandMappings = __commonJS({
  "node_modules/mathjax-full/js/input/tex/newcommand/NewcommandMappings.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
...
var require_NewcommandConfiguration = __commonJS({
  "node_modules/mathjax-full/js/input/tex/newcommand/NewcommandConfiguration.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0) k2 = k;
      var desc = Object.getOwnPropertyDescriptor(m, k);
...
var require_ExtpfeilConfiguration = __commonJS({
  "node_modules/mathjax-full/js/input/tex/extpfeil/ExtpfeilConfiguration.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    ...
    var AmsMethods_js_1 = require_AmsMethods();
    var NewcommandUtil_js_1 = __importDefault(require_NewcommandUtil());
    var NewcommandConfiguration_js_1 = require_NewcommandConfiguration();
    var TexError_js_1 = __importDefault(require_TexError());
...
var require_GensymbConfiguration = __commonJS({
  "node_modules/mathjax-full/js/input/tex/gensymb/GensymbConfiguration.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_HtmlMethods = __commonJS({
  "node_modules/mathjax-full/js/input/tex/html/HtmlMethods.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
...
var require_HtmlConfiguration = __commonJS({
  "node_modules/mathjax-full/js/input/tex/html/HtmlConfiguration.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    ...
    var Configuration_js_1 = require_Configuration();
    var SymbolMap_js_1 = require_SymbolMap();
    var HtmlMethods_js_1 = __importDefault(require_HtmlMethods());
...
var require_MathtoolsUtil = __commonJS({
  "node_modules/mathjax-full/js/input/tex/mathtools/MathtoolsUtil.js"(exports) {
    "use strict";
    var __read = exports && exports.__read || function(o, n) {
      var m = typeof Symbol === "function" && o[Symbol.iterator];
      if (!m) return o;
    ...
    var Symbol_js_1 = require_Symbol();
    var Options_js_1 = require_Options();
    var MathtoolsMethods_js_1 = require_MathtoolsMethods();
    var MathtoolsConfiguration_js_1 = require_MathtoolsConfiguration();
...
var require_MathtoolsMethods = __commonJS({
  "node_modules/mathjax-full/js/input/tex/mathtools/MathtoolsMethods.js"(exports) {
    "use strict";
    var __assign = exports && exports.__assign || function() {
      __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
    ...
    var NewcommandUtil_js_1 = __importDefault(require_NewcommandUtil());
    var NewcommandMethods_js_1 = __importDefault(require_NewcommandMethods());
    var MathtoolsUtil_js_1 = require_MathtoolsUtil();
    exports.MathtoolsMethods = {
      ...
      UnderOverBracket: function(parser, name) {
        ...
        var arg = parser.GetArgument(name);
        var _a = __read(name.charAt(1) === "o" ? ["over", "accent", "bottom"] : ["under", "accentunder", "top"], 3), pos = _a[0], accent = _a[1], border = _a[2];
      ...
      SetOptions: function(parser, name) {
        ...
        var allowed = {};
        Object.keys(options).forEach(function(id2) {
          if (id2 !== "pariedDelimiters" && id2 !== "tagforms" && id2 !== "allow-mathtoolsset") {
            allowed[id2] = 1;
          }
        });
...
var require_MathtoolsMappings = __commonJS({
  "node_modules/mathjax-full/js/input/tex/mathtools/MathtoolsMappings.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
...
var require_MathtoolsTags = __commonJS({
  "node_modules/mathjax-full/js/input/tex/mathtools/MathtoolsTags.js"(exports) {
    "use strict";
    var __extends = exports && exports.__extends || /* @__PURE__ */ function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
    ...
    function MathtoolsTagFormat(config, jax) {
      ...
      var TagFormat = function(_super) {
        ...
        function TagFormat2() {
          ...
          _this.mtFormats = /* @__PURE__ */ new Map();
...
var require_MathtoolsItems = __commonJS({
  "node_modules/mathjax-full/js/input/tex/mathtools/MathtoolsItems.js"(exports) {
    "use strict";
    var __extends = exports && exports.__extends || /* @__PURE__ */ function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
    ...
    var MultlinedItem = function(_super) {
      __extends(MultlinedItem2, _super);
      function MultlinedItem2() {
        return _super !== null && _super.apply(this, arguments) || this;
      }
      Object.defineProperty(MultlinedItem2.prototype, "kind", {
        get: function() {
          return "multlined";
        },
        enumerable: false,
      ...
      MultlinedItem2.prototype.EndTable = function() {
...
var require_MathtoolsConfiguration = __commonJS({
  "node_modules/mathjax-full/js/input/tex/mathtools/MathtoolsConfiguration.js"(exports) {
    "use strict";
    var __values = exports && exports.__values || function(o) {
      var s = typeof Symbol === "function" && Symbol.iterator, m = s && o[s], i = 0;
      if (m) return m.call(o);
    ...
    var NodeUtil_js_1 = __importDefault(require_NodeUtil());
    var Options_js_1 = require_Options();
    require_MathtoolsMappings();
    var MathtoolsUtil_js_1 = require_MathtoolsUtil();
    var MathtoolsTags_js_1 = require_MathtoolsTags();
    var MathtoolsItems_js_1 = require_MathtoolsItems();
...
var require_mhchemParser = __commonJS({
  "node_modules/mhchemparser/dist/mhchemParser.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.mhchemParser = void 0;
    var mhchemParser = function() {
      function mhchemParser2() {
      }
      mhchemParser2.toTex = function(input, type) {
        return _mhchemTexify.go(_mhchemParser.go(input, type), type !== "tex");
      };
      return mhchemParser2;
    }();
        ...
        findObserveGroups: function(input, begExcl, begIncl, endIncl, endExcl, beg2Excl, beg2Incl, end2Incl, end2Excl, combine) {
          var _match = function(input2, pattern) {
            if (typeof pattern === "string") {
              ...
              var match_1 = input2.match(pattern);
              if (!match_1) {
                return null;
              }
              return match_1[0];
          ...
          var _findObserveGroups = function(input2, i, endChars) {
            ...
            while (i < input2.length) {
              ...
              var match_2 = _match(input2.substr(i), endChars);
...
var require_MhchemConfiguration = __commonJS({
  "node_modules/mathjax-full/js/input/tex/mhchem/MhchemConfiguration.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    ...
    var BaseMethods_js_1 = __importDefault(require_BaseMethods());
    var AmsMethods_js_1 = require_AmsMethods();
    var mhchemParser_js_1 = require_mhchemParser();
    var MhchemMethods = {};
...
var require_NoErrorsConfiguration = __commonJS({
  "node_modules/mathjax-full/js/input/tex/noerrors/NoErrorsConfiguration.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_NoUndefinedConfiguration = __commonJS({
  "node_modules/mathjax-full/js/input/tex/noundefined/NoUndefinedConfiguration.js"(exports) {
    "use strict";
    var __values = exports && exports.__values || function(o) {
      var s = typeof Symbol === "function" && Symbol.iterator, m = s && o[s], i = 0;
      if (m) return m.call(o);
...
var require_PhysicsItems = __commonJS({
  "node_modules/mathjax-full/js/input/tex/physics/PhysicsItems.js"(exports) {
    "use strict";
    var __extends = exports && exports.__extends || /* @__PURE__ */ function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
    ...
    var AutoOpen = function(_super) {
      ...
      AutoOpen2.errors = Object.assign(Object.create(StackItem_js_1.BaseItem.errors), {
...
var require_PhysicsMethods = __commonJS({
  "node_modules/mathjax-full/js/input/tex/physics/PhysicsMethods.js"(exports) {
    "use strict";
    var __read = exports && exports.__read || function(o, n) {
      var m = typeof Symbol === "function" && o[Symbol.iterator];
      if (!m) return o;
    ...
    PhysicsMethods.Quantity = function(parser, name, open, close, arg, named, variant) {
      ...
      parser.i++;
      parser.Push(parser.itemFactory.create("auto open").setProperties({ open: next, close: right, big }));
    };
    ...
    var greekCap = [913, 937];
    var greekSmall = [945, 969];
    var digits = [48, 57];
    ...
    PhysicsMethods.Derivative = function(parser, name, argMax, op) {
      ...
      if (parser.GetNext() === "(") {
        parser.i++;
        parser.Push(parser.itemFactory.create("auto open").setProperties({ open: "(", close: ")", ignore }));
      }
    };
...
var require_PhysicsMappings = __commonJS({
  "node_modules/mathjax-full/js/input/tex/physics/PhysicsMappings.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    Object.defineProperty(exports, "__esModule", { value: true });
    var SymbolMap_js_1 = require_SymbolMap();
    var PhysicsMethods_js_1 = __importDefault(require_PhysicsMethods());
    var TexConstants_js_1 = require_TexConstants();
    var ParseMethods_js_1 = __importDefault(require_ParseMethods());
    var MmlNode_js_1 = require_MmlNode();
...
var require_PhysicsConfiguration = __commonJS({
  "node_modules/mathjax-full/js/input/tex/physics/PhysicsConfiguration.js"(exports) {
    "use strict";
    var _a;
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.PhysicsConfiguration = void 0;
    var Configuration_js_1 = require_Configuration();
    var PhysicsItems_js_1 = require_PhysicsItems();
    require_PhysicsMappings();
...
var require_SetOptionsConfiguration = __commonJS({
  "node_modules/mathjax-full/js/input/tex/setoptions/SetOptionsConfiguration.js"(exports) {
    "use strict";
    var __values = exports && exports.__values || function(o) {
      var s = typeof Symbol === "function" && Symbol.iterator, m = s && o[s], i = 0;
      if (m) return m.call(o);
    ...
    exports.SetOptionsUtil = {
      filterPackage: function(parser, extension) {
        ...
        if (options === void 0 && !config.allowPackageDefault || options === false) {
    ...
    function setoptionsConfig(_config, jax) {
      var require2 = jax.parseOptions.handlers.get("macro").lookup("require");
      if (require2) {
        setOptionsMap.add("Require", new Symbol_js_1.Macro("Require", require2._func));
...
var require_TagFormatConfiguration = __commonJS({
  "node_modules/mathjax-full/js/input/tex/tagformat/TagFormatConfiguration.js"(exports) {
    "use strict";
    var __extends = exports && exports.__extends || /* @__PURE__ */ function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
...
var require_TextMacrosMethods = __commonJS({
  "node_modules/mathjax-full/js/input/tex/textmacros/TextMacrosMethods.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
...
var require_TextParser = __commonJS({
  "node_modules/mathjax-full/js/input/tex/textmacros/TextParser.js"(exports) {
    "use strict";
    var __extends = exports && exports.__extends || /* @__PURE__ */ function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d2, b2) {
    ...
    var TextParser = function(_super) {
      ...
      TextParser2.prototype.mml = function() {
        return this.level != null ? this.create("node", "mstyle", this.nodes, { displaystyle: false, scriptlevel: this.level }) : this.nodes.length === 1 ? this.nodes[0] : this.create("node", "mrow", this.nodes);
      };
      ...
      TextParser2.prototype.saveText = function() {
        if (this.text) {
          ...
          var text = ParseUtil_js_1.default.internalText(this, this.text, mathvariant ? { mathvariant } : {});
          this.text = "";
          this.Push(text);
        }
      };
...
var require_TextcompMappings = __commonJS({
  "node_modules/mathjax-full/js/input/tex/textcomp/TextcompMappings.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    ...
    var SymbolMap_js_1 = require_SymbolMap();
    var TexConstants_js_1 = require_TexConstants();
    var TextMacrosMethods_js_1 = require_TextMacrosMethods();
    var ParseUtil_js_1 = __importDefault(require_ParseUtil());
    var TextParser_js_1 = require_TextParser();
...
var require_TextcompConfiguration = __commonJS({
  "node_modules/mathjax-full/js/input/tex/textcomp/TextcompConfiguration.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.TextcompConfiguration = void 0;
    var Configuration_js_1 = require_Configuration();
    require_TextcompMappings();
...
var require_TextMacrosMappings = __commonJS({
  "node_modules/mathjax-full/js/input/tex/textmacros/TextMacrosMappings.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var SymbolMap_js_1 = require_SymbolMap();
    var TexConstants_js_1 = require_TexConstants();
...
var require_TextMacrosConfiguration = __commonJS({
  "node_modules/mathjax-full/js/input/tex/textmacros/TextMacrosConfiguration.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    ...
    function internalMath(parser, text, level, mathvariant) {
      ...
      return [new TextParser_js_1.TextParser(text, mathvariant ? { mathvariant } : {}, config.parseOptions, level).mml()];
    }
...
var require_UpgreekConfiguration = __commonJS({
  "node_modules/mathjax-full/js/input/tex/upgreek/UpgreekConfiguration.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_UnicodeConfiguration = __commonJS({
  "node_modules/mathjax-full/js/input/tex/unicode/UnicodeConfiguration.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
...
var require_VerbConfiguration = __commonJS({
  "node_modules/mathjax-full/js/input/tex/verb/VerbConfiguration.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
...
var require_AllPackages = __commonJS({
  "node_modules/mathjax-full/js/input/tex/AllPackages.js"(exports) {
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.AllPackages = void 0;
    require_BaseConfiguration();
    require_ActionConfiguration();
    require_AmsConfiguration();
    require_AmsCdConfiguration();
    require_BboxConfiguration();
    require_BoldsymbolConfiguration();
    require_BraketConfiguration();
    require_BussproofsConfiguration();
    require_CancelConfiguration();
    require_CasesConfiguration();
    require_CenternotConfiguration();
    require_ColorConfiguration();
    require_ColorV2Configuration();
    require_ColortblConfiguration();
    require_ConfigMacrosConfiguration();
    require_EmpheqConfiguration();
    require_EncloseConfiguration();
    require_ExtpfeilConfiguration();
    require_GensymbConfiguration();
    require_HtmlConfiguration();
    require_MathtoolsConfiguration();
    require_MhchemConfiguration();
    require_NewcommandConfiguration();
    require_NoErrorsConfiguration();
    require_NoUndefinedConfiguration();
    require_PhysicsConfiguration();
    require_SetOptionsConfiguration();
    require_TagFormatConfiguration();
    require_TextcompConfiguration();
    require_TextMacrosConfiguration();
    require_UpgreekConfiguration();
    require_UnicodeConfiguration();
    require_VerbConfiguration();
...
export default require_AllPackages();
...
mhchemparser/dist/mhchemParser.js:
   ...
   *)
*/
//# sourceMappingURL=mathjax-full_js_input_tex_AllPackages__js.js.map
